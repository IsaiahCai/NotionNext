...
const BLOG = {
  AUTHOR: 'ic21', // 作者
  BIO: '一个探索者', // 作者简介
  LINK: 'https://notion-next-beige-five.vercel.app/', // 网站地址
  KEYWORDS: '甜菜写博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'caizhidian@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/IsaiahCai',
  CONTACT_TELEGRAM: '',
